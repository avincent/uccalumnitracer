...
<div class="ml-2 p-4"> {{-- pushes content to the right (because of sidebar) --}}
    <h1 class="text-3xl font-bold text-gray-700 mb-6 mt-12">🔍 Search Results for "{{ request('search') }}"</h1>

    {{-- Back to Directory Button --}}
    <div class="flex justify-end mb-4">
        <a href="{{ route('alumnis.index') }}" class="bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded shadow">
            ← Back to Directory
        </a>
    </div>
